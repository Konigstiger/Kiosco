...
namespace Data
{
    public class ClienteData
    {
        public static List<ClienteView> GetAll()
        {
            ...
            var cmd = new SqlCommand("Cliente_GetAll", conn) {CommandType = CommandType.StoredProcedure};
        ...
        public static Cliente GetByPrimaryKey(long idCliente)
        {
            ...
            var conn = new SqlConnection(GeneralData.CadenaConexion);
            SqlDataReader rdr = null;
            var cmd = new SqlCommand("Cliente_GetByPrimaryKey", conn) {CommandType = CommandType.StoredProcedure};
        ...
        public static List<ClienteView> GetAll_GetByDescripcion(string descripcion)
        {
            ...
            var conn = new SqlConnection(GeneralData.CadenaConexion);
            SqlDataReader rdr = null;
            var cmd = new SqlCommand("Cliente_GetByDescripcion", conn)
            {
